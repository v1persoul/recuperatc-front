    ...
    <Box bg="white" p={1}>
      <Flex alignItems="center" justifyContent="space-between">
        <Flex alignItems="center">
            <Image src="./dist/assets/lizsinfondobn.png" alt="Logo Universidad Veracruzana" height="40px" mb={1} ml={10}/>
        ...
        <Flex alignItems="center">
            ...
            <Image src="./dist/assets/logofei.png" alt="Logo Tecnologías Computacionales" height="40px" mb={1} mr={10}/>
        </Flex>
      </Flex>
    </Box>
  );
